...
public class RTeamLog {
	...
	public static void i(TagSuffix tagSuffix, String msg) { Log.i(tagSuffix.getTag(), msg); }
	...
	public static void w(TagSuffix tagSuffix, String msg) { Log.w(tagSuffix.getTag(), msg); }
	...
	public static void e(TagSuffix tagSuffix, String msg) { Log.e(tagSuffix.getTag(), msg); }
	...
	public static void d(TagSuffix tagSuffix, String msg) { Log.d(tagSuffix.getTag(), msg); }	
}
