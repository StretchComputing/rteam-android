/*
 * Source: https://github.com/jasonkostempski/Android-CalendarView/wiki
 */
...
public class CalendarView extends LinearLayout {
	...
	public interface OnSelectedDayChangedListener {
		public boolean onSelectedDayChanged(CalendarView view);
	}
	...
	private OnClickListener _dayClicked = new OnClickListener() {
		public void onClick(View v) {
			...
			if(invokeSelectedDayChangedListener()) {
				setView(DAY_VIEW);
			}
			else {
				markDaySelected(tv);
	...
	private void markDaySelected(TextView daySelected) {
		...
		_lastDayClicked = daySelected;
		_lastDayClicked.setTextColor(Color.WHITE);
		_lastDayClicked.setTextSize(daySelected.getTextSize() * 1.15f);
	}
	...
	private boolean invokeSelectedDayChangedListener() {
		if (_onSelectedDayChangedListener != null)
			return _onSelectedDayChangedListener.onSelectedDayChanged(this);
		return true;
	}
